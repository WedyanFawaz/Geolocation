  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      leading:  IconButton(  onPressed: () {
                    ...
                    title: Text('عرض الطريق',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),),
            ...
            children: [
              ...
              Expanded(
                ...
                textAlign: TextAlign.right,
                        ...
                        decoration: InputDecoration(hintText: 'نقطة البداية'),
                        onChanged: (value) {
                          print(value);
                        },
                      ),
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(hintText: 'نقطة النهاية'),
                        onChanged: (value) {
                          print(value);
                        },
                      ),
